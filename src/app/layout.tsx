...
export const metadata: Metadata = {
  title: "SEMT – Substation Equipment Maintenance Tracker",
  description: "Professional substation equipment inventory, inspection, maintenance scheduling and reporting.",
};
